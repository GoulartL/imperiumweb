                    ...
                    <table class="table table-striped w-100" id="tbOrders">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="0">Dt. Entrada</th>
                                <th data-priority="0">NF Entrada</th>
                                <th data-priority="0">Ref.</th>
                                <th data-priority="0">Modelo</th>
                                <th data-priority="0">Coleção</th>
                                <th data-priority="0">Qtd.</th>
                                <th data-priority="0">Valor Unit.</th>
                                <th data-priority="0">Total</th>
                                <th data-priority="0">Observações</th>
...
<script src="{{ asset('assets/views/orders/orders.js') }}"></script>
@endSection
