...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Fornecedores</h3>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped w-100" id="tbSuppliers">
                        <thead>
                            <tr>
...
<script src="{{ asset('assets/views/suppliers/suppliers.js') }}"></script>
@endSection
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mdCrudTitle">Novo fornecedor</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="mdCrudBody">
                <form id="supplierForm" action="POST" autocomplete="off">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="mdCrudSave" form="supplierForm">Salvar</button>
            </div>
        </div>
    </div>
</div>
